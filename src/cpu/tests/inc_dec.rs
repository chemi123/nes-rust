...
fn test_inc_zero_page() {
    ...
    assert_eq!(cpu.memory.read(0x10), 0x06);
}
...
fn test_inc_negative_flag() {
    ...
    cpu.run(&[INC_ZERO_PAGE, 0x10, BRK]);
    assert_eq!(cpu.memory.read(0x10), 0x80);
...
fn test_inc_absolute() {
    ...
    assert_eq!(cpu.memory.read(0x0200), 0x06);
}
...
fn test_dec_zero_page() {
    ...
    assert_eq!(cpu.memory.read(0x10), 0x04);
}
...
fn test_dec_absolute() {
    ...
    assert_eq!(cpu.memory.read(0x0200), 0x04);
}
